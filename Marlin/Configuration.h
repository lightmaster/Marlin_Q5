...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp   7.38662
    #define DEFAULT_Ki   0.30717
    #define DEFAULT_Kd  44.40654
  #endif
#endif // PIDTEMP
...
#define DEFAULT_RETRACT_ACCELERATION  1500    // E acceleration for retracts (Was set for 1500)
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MAX_POS - 5) , (Y_MAX_POS - 5), 20 } // Around 70,70, 197

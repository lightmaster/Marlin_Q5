...
#define STRING_CONFIG_H_AUTHOR "Lightmaster, Phteven, FLSun Q5" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp   7.92974
    #define DEFAULT_Ki   0.33151
    #define DEFAULT_Kd  47.41987
  #endif
#endif // PIDTEMP
...
#define DELTA
  ...
  #define DELTA_HEIGHT                  196.67274            // (mm) Get this value from G33 auto calibrate //@ UPDATED was 197.056
  ...
  // Override with M665 ABC
  #define DELTA_DIAGONAL_ROD_TRIM_TOWER { 0.0000, 0.1375, 0.0000 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_XYZ_STEPS_PER_UNIT 80.00
#define DEFAULT_E0_STEPS_PER_UNIT 423.2973825
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 3000, 3000, 8000 }    //Extruder was set to 8000
...
#define DEFAULT_RETRACT_ACCELERATION  3000    // E acceleration for retracts (Was set for 1500)
...
#define NOZZLE_TO_PROBE_OFFSET { -2.3, -1.4, -19.38900}
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { -70, 70, 20 } // Around 70,70, 197
...
// #define RGBW_LED
  ...
  #define RGB_LED_R_PIN PA6
  #define RGB_LED_G_PIN PA8
  #define RGB_LED_B_PIN PA10
  #define RGB_LED_W_PIN PC7
#endif

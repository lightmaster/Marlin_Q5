...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 40*60, 40*60, 40*60, 6.67*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
#define FWRETRACT
  ...
  #define RETRACT_RECOVER_FEEDRATE     75   // (mm/s) Default feedrate for recovering from retraction
  #define RETRACT_RECOVER_FEEDRATE_SWAP 75   // (mm/s) Default feedrate for recovering from swap retraction
...
#define CUSTOM_MENU_MAIN
  ...
  #define CUSTOM_MENU_MAIN_TITLE "GCode Scripts"
  #define CUSTOM_MENU_MAIN_SCRIPT_DONE "M117 User Script Done"
  #define CUSTOM_MENU_MAIN_SCRIPT_AUDIBLE_FEEDBACK
  //#define CUSTOM_MENU_MAIN_SCRIPT_RETURN   // Return to status screen after a script
  //#define CUSTOM_MENU_MAIN_ONLY_IDLE         // Only show custom menu when the machine is idle

  #define MAIN_MENU_ITEM_1_DESC "Bright Lights"
  #define MAIN_MENU_ITEM_1_GCODE "M150 R255 U255 B255 P255"
  //#define MAIN_MENU_ITEM_1_CONFIRM          // Show a confirmation dialog before this action

  #define MAIN_MENU_ITEM_2_DESC "Mid Lights"
  #define MAIN_MENU_ITEM_2_GCODE "M150 R255 U255 B255 P126"
  //#define MAIN_MENU_ITEM_2_CONFIRM

  #define MAIN_MENU_ITEM_3_DESC "Dim Lights"
  #define MAIN_MENU_ITEM_3_GCODE "M150 R255 U255 B255 P50"
  //#define MAIN_MENU_ITEM_3_CONFIRM

  #define MAIN_MENU_ITEM_4_DESC "Retract Filament"
  #define MAIN_MENU_ITEM_4_GCODE "M83\nG1 E-4 F1500"
  //#define MAIN_MENU_ITEM_4_CONFIRM

  #define MAIN_MENU_ITEM_5_DESC "Pause OctoPrint"
  #define MAIN_MENU_ITEM_5_GCODE "M118 A1 ACTION:PAUSE"
  #define MAIN_MENU_ITEM_5_CONFIRM

  #define MAIN_MENU_ITEM_6_DESC "Resume OctoPrint"
  #define MAIN_MENU_ITEM_6_GCODE "M118 A1 ACTION:RESUME"
  #define MAIN_MENU_ITEM_6_CONFIRM

  #define MAIN_MENU_ITEM_7_DESC "Cancel OctoPrint"
  #define MAIN_MENU_ITEM_7_GCODE "M118 A1 ACTION:CANCEL"
